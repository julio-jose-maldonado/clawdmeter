...
### Added
- Alertas por umbral de uso (`alerts.ino`): beep en buzzer pasivo + parpadeo del LED de la metrica cuando el uso de 5h o 7 dias cruza el umbral de aviso (def. 80%) o critico (def. 95%)
